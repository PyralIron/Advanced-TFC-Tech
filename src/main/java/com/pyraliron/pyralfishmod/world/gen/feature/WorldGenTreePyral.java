package com.pyraliron.pyralfishmod.world.gen.feature;
...
public class WorldGenTreePyral extends WorldGenAbstractTree {
	...
	public WorldGenTreePyral(boolean notify) {
		super(notify);
	...
	protected boolean canGrowInto(Block blockType)
    {
        ...
        return blockType == ModBlocks.GRASS_BLOCK_PYRAL || blockType == ModBlocks.DIRT_BLOCK_PYRAL || material == Material.AIR || material == Material.LEAVES || blockType == Blocks.GRASS || blockType == Blocks.DIRT || blockType == Blocks.LOG || blockType == Blocks.LOG2 || blockType == Blocks.SAPLING || blockType == Blocks.VINE;
    }
	...
	public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = state.getBlock().canSustainPlant(state, worldIn, down, net.minecraft.util.EnumFacing.UP, (BlockSaplingPyral)ModBlocks.SAPLING_PYRAL);
