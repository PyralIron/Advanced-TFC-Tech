...
public class ChunkGeneratorOverworldPyral implements IChunkGenerator {
    ...
    //private WoodlandMansion woodlandMansionGenerator = new WoodlandMansion(new FakeMansionChunkProvider());
	...
	public ChunkGeneratorOverworldPyral(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions)
    {
	...
	private class FakeMansionChunkProvider extends ChunkGeneratorOverworld
    {
        ...
        {
            super(ChunkGeneratorOverworldPyral.this.world, 0, true, "");
        }

        @Override
        public void setBlocksInChunk(int x, int z, ChunkPrimer primer)
        {
            ChunkGeneratorOverworldPyral.this.setBlocksInChunk(x, z, primer);
        }
    }
