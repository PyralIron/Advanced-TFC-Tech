...
public class BlockBushPyral extends BlockBase implements net.minecraftforge.common.IPlantable {
	
	protected static final AxisAlignedBB BUSH_AABB = new AxisAlignedBB(0.30000001192092896D, 0.0D, 0.30000001192092896D, 0.699999988079071D, 0.6000000238418579D, 0.699999988079071D);
	
	public BlockBushPyral() {
		super(Material.PLANTS,"sapling_pyral" , CreativeTabs.DECORATIONS);
	}
    ...
    {
        return state.getBlock() == Blocks.GRASS || state.getBlock() == Blocks.DIRT || state.getBlock() == Blocks.FARMLAND || state.getBlock() == ModBlocks.GRASS_BLOCK_PYRAL || state.getBlock() == ModBlocks.DIRT_BLOCK_PYRAL;
    }
