...
public abstract class BlockContainerPyral extends BlockBase implements ITileEntityProvider
{
    protected BlockContainerPyral(Material materialIn, String name, CreativeTabs tab)
    {
        this(materialIn, materialIn.getMaterialMapColor(), name, tab);
    }

    protected BlockContainerPyral(Material materialIn, MapColor color, String name, CreativeTabs tab)
    {
