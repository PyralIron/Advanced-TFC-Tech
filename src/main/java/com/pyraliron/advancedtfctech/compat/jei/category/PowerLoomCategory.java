...
public class PowerLoomCategory extends BaseRecipeCategory<MultiblockRecipeWrapper> {
    ...
    public PowerLoomCategory(IGuiHelper helper, String id)
    {
        super(helper.createBlankDrawable(120, 38), id);
        gears = helper.createDrawable(ICONS, 0, 134-16, 22, 16);
        IDrawableStatic arrowAnimated = helper.createDrawable(ICONS, 22, 134-16, 22, 16);
    ...
    public void drawExtras(Minecraft minecraft)
    {
        ...
        slot.draw(minecraft, 20, 20);
        slot.draw(minecraft, 20, 0);
    ...
    public void setRecipe(IRecipeLayout recipeLayout, MultiblockRecipeWrapper recipeWrapper, IIngredients ingredients)
    {
        ...
        itemStackGroup.init(0, true, 20, 20);
        itemStackGroup.init(1, true, 20, 0);
        itemStackGroup.init(2, false, 84, 0);
        itemStackGroup.init(3, false, 84, 20);
