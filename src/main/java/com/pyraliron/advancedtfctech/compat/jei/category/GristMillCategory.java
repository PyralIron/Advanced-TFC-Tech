...
public class GristMillCategory extends BaseRecipeCategory<MultiblockRecipeWrapper> {
    ...
    public GristMillCategory(IGuiHelper helper, String id)
    {
    ...
    public void setRecipe(IRecipeLayout recipeLayout, MultiblockRecipeWrapper recipeWrapper, IIngredients ingredients)
    {
        IGuiItemStackGroup itemStackGroup = recipeLayout.getItemStacks();
            itemStackGroup.init(0, false, 20, 10);
        itemStackGroup.init(1, true, 84, 10);
