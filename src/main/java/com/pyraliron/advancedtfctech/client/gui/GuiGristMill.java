...
public class GuiGristMill extends GuiIEContainerBase
{
    TileEntityGristMill tile;
    public GuiGristMill(InventoryPlayer inventoryPlayer, TileEntityGristMill tile)
    {

        super(new ContainerGristMill(inventoryPlayer, tile));
