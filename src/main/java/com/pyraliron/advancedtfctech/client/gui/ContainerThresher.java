...
public class ContainerThresher extends ContainerIEBase<TileEntityThresher> {
    public ContainerThresher(InventoryPlayer inventoryPlayer, TileEntityThresher tile)
    {
        ...
        //tile.container = this;
        for(int i=0; i<6; i++)
            this.addSlotToContainer(new ATTSlot.ThresherInput(this, this.inv, i, 62+18*(i%3),16+18*(i/3)));
        for(int i=0; i<6; i++)
