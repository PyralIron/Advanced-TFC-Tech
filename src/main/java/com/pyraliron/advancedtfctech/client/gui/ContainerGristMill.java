...
public class ContainerGristMill extends ContainerIEBase<TileEntityGristMill> {
    public ContainerGristMill(InventoryPlayer inventoryPlayer, TileEntityGristMill tile)
    {
