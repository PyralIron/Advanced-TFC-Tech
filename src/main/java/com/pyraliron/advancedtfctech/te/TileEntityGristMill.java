...
public class TileEntityGristMill extends TileEntityMultiblockMetal<TileEntityGristMill, IMultiblockRecipe> implements IEBlockInterfaces.IAdvancedSelectionBounds, IEBlockInterfaces.IAdvancedCollisionBounds,IEBlockInterfaces.IGuiTile {
    ...
    public static class TileEntityGristMillParent extends TileEntityGristMill
    {
        ...
        public AxisAlignedBB getRenderBoundingBox()
        {
            ...
            if (facing == EnumFacing.NORTH) {
                return new AxisAlignedBB(getPos().getX()-4,getPos().getY()-1,getPos().getZ()-3,getPos().getX()+3,getPos().getY()+2,getPos().getZ()+3);
    ...
    public TileEntityGristMill()
    {
        super(MultiblockGristMill.instance, new int[]{3, 3, 4}, 16000, true);
            ...
            if (this.processQueue.size() < this.getProcessQueueMaxLength())
            {
                ...
                for (int slot = 0; slot < 6; slot++) {
                    ...
                    if (!stack.isEmpty() && stack.getCount() > 0) {
                        ...
                        if (recipe != null) {
                            TileEntityGristMill.MultiblockProcessGristMill process = new TileEntityGristMill.MultiblockProcessGristMill(recipe, slot);
    ...
    public List<AxisAlignedBB> getAdvancedSelectionBounds()
    {
        ...
        if (this.pos == 2 || this.pos == 7 || this.pos == 18 || this.pos == 4 || this.pos == 30 || this.pos == 22) {
            ...
            return list;
        } else if (this.pos == 13 || this.pos == 1) {
            List list = Lists.newArrayList();
            float minY = this.pos == 1 ? 8*s : 0;
            float maxY = this.pos == 1 ? 1 : 4*s;
            if (this.mirrored) {
                float minX = fl == EnumFacing.NORTH ? 0 : fl == EnumFacing.SOUTH ? 12 * s : fl == EnumFacing.WEST ? 0 : 8 * s;
                float maxX = fl == EnumFacing.NORTH ? 4 * s : fl == EnumFacing.SOUTH ? 1 : fl == EnumFacing.WEST ? 8 * s : 1;
                float minZ = fl == EnumFacing.NORTH ? 0 : fl == EnumFacing.SOUTH ? 8 * s : fl == EnumFacing.WEST ? 12 * s : 0;
                float maxZ = fl == EnumFacing.NORTH ? 8 * s : fl == EnumFacing.SOUTH ? 1 : fl == EnumFacing.WEST ? 1 : 4 * s;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
                minX = fl == EnumFacing.NORTH ? 4 * s : fl == EnumFacing.SOUTH ? 0 : fl == EnumFacing.WEST ? 0.5F * s : 11.5F * s;
                maxX = fl == EnumFacing.NORTH ? 1 : fl == EnumFacing.SOUTH ? 12 * s : fl == EnumFacing.WEST ? 4.5F * s : 15.5F * s;
                minZ = fl == EnumFacing.NORTH ? 0.5F * s : fl == EnumFacing.SOUTH ? 11.5F * s : fl == EnumFacing.WEST ? 0 : 4 * s;
                maxZ = fl == EnumFacing.NORTH ? 4.5F * s : fl == EnumFacing.SOUTH ? 15.5F * s : fl == EnumFacing.WEST ? 12 * s : 1;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            } else {
                float minX = fl == EnumFacing.SOUTH ? 0 : fl == EnumFacing.NORTH ? 12 * s : fl == EnumFacing.WEST ? 0 : 8 * s;
                float maxX = fl == EnumFacing.SOUTH ? 4 * s : fl == EnumFacing.NORTH ? 1 : fl == EnumFacing.WEST ? 8 * s : 1;
                float minZ = fl == EnumFacing.NORTH ? 0 : fl == EnumFacing.SOUTH ? 8 * s : fl == EnumFacing.EAST ? 12 * s : 0;
                float maxZ = fl == EnumFacing.NORTH ? 8 * s : fl == EnumFacing.SOUTH ? 1 : fl == EnumFacing.EAST ? 1 : 4 * s;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
                minX = fl == EnumFacing.SOUTH ? 4 * s : fl == EnumFacing.NORTH ? 0 : fl == EnumFacing.WEST ? 0.5F * s : 11.5F * s;
                maxX = fl == EnumFacing.SOUTH ? 1 : fl == EnumFacing.NORTH ? 12 * s : fl == EnumFacing.WEST ? 4.5F * s : 15.5F * s;
                minZ = fl == EnumFacing.NORTH ? 0.5F * s : fl == EnumFacing.SOUTH ? 11.5F * s : fl == EnumFacing.EAST ? 0 : 4 * s;
                maxZ = fl == EnumFacing.NORTH ? 4.5F * s : fl == EnumFacing.SOUTH ? 15.5F * s : fl == EnumFacing.EAST ? 12 * s : 1;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            }
            if (this.pos == 1) list.add(new AxisAlignedBB(0, 0, 0, 1, 0.5F, 1).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            return list;
        } else if (this.pos == 21 || this.pos == 9) {
            List list = Lists.newArrayList();
            float minY = this.pos == 9 ? 8*s : 0;
            float maxY = this.pos == 9 ? 1 : 4*s;
            if (this.mirrored) {
                float minX = fl == EnumFacing.NORTH ? 0 : fl == EnumFacing.SOUTH ? 12 * s : fl == EnumFacing.WEST ? 8 * s : 0;
                float maxX = fl == EnumFacing.NORTH ? 4 * s : fl == EnumFacing.SOUTH ? 1 : fl == EnumFacing.WEST ? 1 : 8 * s;
                float minZ = fl == EnumFacing.NORTH ? 8 * s : fl == EnumFacing.SOUTH ? 0 : fl == EnumFacing.WEST ? 12 * s : 0;
                float maxZ = fl == EnumFacing.NORTH ? 1 : fl == EnumFacing.SOUTH ? 8 * s : fl == EnumFacing.WEST ? 1 : 4 * s;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
                minX = fl == EnumFacing.NORTH ? 4 * s : fl == EnumFacing.SOUTH ? 0 : fl == EnumFacing.WEST ? 11.5F * s : 0.5F * s;
                maxX = fl == EnumFacing.NORTH ? 1 : fl == EnumFacing.SOUTH ? 12 * s : fl == EnumFacing.WEST ? 15.5F * s : 4.5F * s;
                minZ = fl == EnumFacing.NORTH ? 11.5F * s : fl == EnumFacing.SOUTH ? 0.5F * s : fl == EnumFacing.WEST ? 0 : 4 * s;
                maxZ = fl == EnumFacing.NORTH ? 15.5F * s : fl == EnumFacing.SOUTH ? 4.5F * s : fl == EnumFacing.WEST ? 12 * s : 1;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            } else {
                float minX = fl == EnumFacing.SOUTH ? 0 : fl == EnumFacing.NORTH ? 12 * s : fl == EnumFacing.WEST ? 8 * s : 0;
                float maxX = fl == EnumFacing.SOUTH ? 4 * s : fl == EnumFacing.NORTH ? 1 : fl == EnumFacing.WEST ? 1 : 8 * s;
                float minZ = fl == EnumFacing.NORTH ? 8 * s : fl == EnumFacing.SOUTH ? 0 : fl == EnumFacing.EAST ? 12 * s : 0;
                float maxZ = fl == EnumFacing.NORTH ? 1 : fl == EnumFacing.SOUTH ? 8 * s : fl == EnumFacing.EAST ? 1 : 4 * s;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
                minX = fl == EnumFacing.SOUTH ? 4 * s : fl == EnumFacing.NORTH ? 0 : fl == EnumFacing.WEST ? 11.5F * s : 0.5F * s;
                maxX = fl == EnumFacing.SOUTH ? 1 : fl == EnumFacing.NORTH ? 12 * s : fl == EnumFacing.WEST ? 15.5F * s : 4.5F * s;
                minZ = fl == EnumFacing.NORTH ? 11.5F * s : fl == EnumFacing.SOUTH ? 0.5F * s : fl == EnumFacing.EAST ? 0 : 4 * s;
                maxZ = fl == EnumFacing.NORTH ? 15.5F * s : fl == EnumFacing.SOUTH ? 4.5F * s : fl == EnumFacing.EAST ? 12 * s : 1;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            }
            if (this.pos == 9) list.add(new AxisAlignedBB(0, 0, 0, 1, 0.5F, 1).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            return list;
        } else if (this.pos == 12 || this.pos == 0) {
            List list = Lists.newArrayList();
            float minY = this.pos == 0 ? 8*s : 0;
            float maxY = this.pos == 0 ? 1 : 4*s;
            if (this.mirrored) {
                float minX = fl == EnumFacing.NORTH ? s : fl == EnumFacing.SOUTH ? 11 * s : fl == EnumFacing.WEST ? 0 : 8 * s;
                float maxX = fl == EnumFacing.NORTH ? 5 * s : fl == EnumFacing.SOUTH ? 15 * s : fl == EnumFacing.WEST ? 8 * s : 1;
                float minZ = fl == EnumFacing.NORTH ? 0 : fl == EnumFacing.SOUTH ? 8 * s : fl == EnumFacing.WEST ? 11 * s : s;
                float maxZ = fl == EnumFacing.NORTH ? 8 * s : fl == EnumFacing.SOUTH ? 1 : fl == EnumFacing.WEST ? 15 * s : 5 * s;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
                minX = fl == EnumFacing.NORTH ? 0 : fl == EnumFacing.SOUTH ? 15 * s : fl == EnumFacing.WEST ? 0.5F * s : 11.5F * s;
                maxX = fl == EnumFacing.NORTH ? s : fl == EnumFacing.SOUTH ? 1 : fl == EnumFacing.WEST ? 4.5F * s : 15.5F * s;
                minZ = fl == EnumFacing.NORTH ? 0.5F * s : fl == EnumFacing.SOUTH ? 11.5F * s : fl == EnumFacing.WEST ? 15 * s : 0;
                maxZ = fl == EnumFacing.NORTH ? 4.5F * s : fl == EnumFacing.SOUTH ? 15.5F * s : fl == EnumFacing.WEST ? 1 : s;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            } else {
                float minX = fl == EnumFacing.SOUTH ? s : fl == EnumFacing.NORTH ? 11 * s : fl == EnumFacing.WEST ? 0 : 8 * s;
                float maxX = fl == EnumFacing.SOUTH ? 5 * s : fl == EnumFacing.NORTH ? 15 * s : fl == EnumFacing.WEST ? 8 * s : 1;
                float minZ = fl == EnumFacing.NORTH ? 0 : fl == EnumFacing.SOUTH ? 8 * s : fl == EnumFacing.EAST ? 11 * s : s;
                float maxZ = fl == EnumFacing.NORTH ? 8 * s : fl == EnumFacing.SOUTH ? 1 : fl == EnumFacing.EAST ? 15 * s : 5 * s;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
                minX = fl == EnumFacing.SOUTH ? 0 : fl == EnumFacing.NORTH ? 15 * s : fl == EnumFacing.WEST ? 0.5F * s : 11.5F * s;
                maxX = fl == EnumFacing.SOUTH ? s : fl == EnumFacing.NORTH ? 1 : fl == EnumFacing.WEST ? 4.5F * s : 15.5F * s;
                minZ = fl == EnumFacing.NORTH ? 0.5F * s : fl == EnumFacing.SOUTH ? 11.5F * s : fl == EnumFacing.EAST ? 15 * s : 0;
                maxZ = fl == EnumFacing.NORTH ? 4.5F * s : fl == EnumFacing.SOUTH ? 15.5F * s : fl == EnumFacing.EAST ? 1 : s;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            }
            if (this.pos == 0) list.add(new AxisAlignedBB(0, 0, 0, 1, 0.5F, 1).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            return list;
        } else if (this.pos == 20 || this.pos == 8) {
            List list = Lists.newArrayList();
            float minY = this.pos == 8 ? 8*s : 0;
            float maxY = this.pos == 8 ? 1 : 4*s;
            if (this.mirrored) {
                float minX = fl == EnumFacing.NORTH ? s : fl == EnumFacing.SOUTH ? 11 * s : fl == EnumFacing.WEST ? 8 * s : 0;
                float maxX = fl == EnumFacing.NORTH ? 5 * s : fl == EnumFacing.SOUTH ? 15 * s : fl == EnumFacing.WEST ? 1 : 8 * s;
                float minZ = fl == EnumFacing.NORTH ? 8 * s : fl == EnumFacing.SOUTH ? 0 : fl == EnumFacing.WEST ? 11 * s : s;
                float maxZ = fl == EnumFacing.NORTH ? 1 : fl == EnumFacing.SOUTH ? 8 * s : fl == EnumFacing.WEST ? 15 * s : 5 * s;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
                minX = fl == EnumFacing.NORTH ? 0 : fl == EnumFacing.SOUTH ? 15 * s : fl == EnumFacing.WEST ? 11.5F * s : 0.5F * s;
                maxX = fl == EnumFacing.NORTH ? s : fl == EnumFacing.SOUTH ? 1 : fl == EnumFacing.WEST ? 15.5F * s : 4.5F * s;
                minZ = fl == EnumFacing.NORTH ? 11.5F * s : fl == EnumFacing.SOUTH ? 0.5F * s : fl == EnumFacing.WEST ? 15 * s : 0;
                maxZ = fl == EnumFacing.NORTH ? 15.5F * s : fl == EnumFacing.SOUTH ? 4.5F * s : fl == EnumFacing.WEST ? 1 : s;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            } else {
                float minX = fl == EnumFacing.SOUTH ? s : fl == EnumFacing.NORTH ? 11 * s : fl == EnumFacing.WEST ? 8 * s : 0;
                float maxX = fl == EnumFacing.SOUTH ? 5 * s : fl == EnumFacing.NORTH ? 15 * s : fl == EnumFacing.WEST ? 1 : 8 * s;
                float minZ = fl == EnumFacing.NORTH ? 8 * s : fl == EnumFacing.SOUTH ? 0 : fl == EnumFacing.EAST ? 11 * s : s;
                float maxZ = fl == EnumFacing.NORTH ? 1 : fl == EnumFacing.SOUTH ? 8 * s : fl == EnumFacing.EAST ? 15 * s : 5 * s;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
                minX = fl == EnumFacing.SOUTH ? 0 : fl == EnumFacing.NORTH ? 15 * s : fl == EnumFacing.WEST ? 11.5F * s : 0.5F * s;
                maxX = fl == EnumFacing.SOUTH ? s : fl == EnumFacing.NORTH ? 1 : fl == EnumFacing.WEST ? 15.5F * s : 4.5F * s;
                minZ = fl == EnumFacing.NORTH ? 11.5F * s : fl == EnumFacing.SOUTH ? 0.5F * s : fl == EnumFacing.EAST ? 15 * s : 0;
                maxZ = fl == EnumFacing.NORTH ? 15.5F * s : fl == EnumFacing.SOUTH ? 4.5F * s : fl == EnumFacing.EAST ? 1 : s;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            }
            if (this.pos == 8) list.add(new AxisAlignedBB(0, 0, 0, 1, 0.5F, 1).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            return list;
        } else if (this.pos == 17 || this.pos == 5) {
            List list = Lists.newArrayList();
            float minY = this.pos == 5 ? 8*s : 0;
            float maxY = this.pos == 5 ? 1 : 4*s;
            if (this.mirrored) {
                float minX = fl == EnumFacing.NORTH ? 0 : fl == EnumFacing.SOUTH ? 12 * s : fl == EnumFacing.WEST ? 0 : 0;
                float maxX = fl == EnumFacing.NORTH ? 4 * s : fl == EnumFacing.SOUTH ? 1 : fl == EnumFacing.WEST ? 1 : 1;
                float minZ = fl == EnumFacing.NORTH ? 0 : fl == EnumFacing.SOUTH ? 0 : fl == EnumFacing.WEST ? 12 * s : 0;
                float maxZ = fl == EnumFacing.NORTH ? 1 : fl == EnumFacing.SOUTH ? 1 : fl == EnumFacing.WEST ? 1 : 4 * s;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            } else {
                float minX = fl == EnumFacing.SOUTH ? 0 : fl == EnumFacing.NORTH ? 12 * s : fl == EnumFacing.WEST ? 0 : 0;
                float maxX = fl == EnumFacing.SOUTH ? 4 * s : fl == EnumFacing.NORTH ? 1 : fl == EnumFacing.WEST ? 1 : 1;
                float minZ = fl == EnumFacing.NORTH ? 0 : fl == EnumFacing.SOUTH ? 0 : fl == EnumFacing.EAST ? 12 * s : 0;
                float maxZ = fl == EnumFacing.NORTH ? 1 : fl == EnumFacing.SOUTH ? 1 : fl == EnumFacing.EAST ? 1 : 4 * s;
                list.add(new AxisAlignedBB(minX, minY, minZ, maxX, maxY, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            }
            if (this.pos == 5) list.add(new AxisAlignedBB(0, 0, 0, 1, 0.5F, 1).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            else {
                float minX = fl == EnumFacing.NORTH ? 0 : fl == EnumFacing.SOUTH ? 0 : fl == EnumFacing.WEST ? 7*s : 7*s;
                float maxX = fl == EnumFacing.NORTH ? 1 : fl == EnumFacing.SOUTH ? 1 : fl == EnumFacing.WEST ? 9*s : 9*s;
                float minZ = fl == EnumFacing.NORTH ? 7*s : fl == EnumFacing.SOUTH ? 7*s : fl == EnumFacing.WEST ? 0 : 0;
                float maxZ = fl == EnumFacing.NORTH ? 9*s : fl == EnumFacing.SOUTH ? 9*s : fl == EnumFacing.WEST ? 1 : 1;
                list.add(new AxisAlignedBB(minX, 5*s, minZ, maxX, 7*s, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            }
            return list;
        } else if (this.pos == 16 || this.pos == 19) {
            List list = Lists.newArrayList();
            float minX = fl == EnumFacing.NORTH ? s : fl == EnumFacing.SOUTH ? s : fl == EnumFacing.WEST ? 0.5F*s : 0.5F*s;
            float maxX = fl == EnumFacing.NORTH ? 15*s : fl == EnumFacing.SOUTH ? 15*s : fl == EnumFacing.WEST ? 15.5F*s : 15.5F*s;
            float minZ = fl == EnumFacing.NORTH ? 0.5F*s : fl == EnumFacing.SOUTH ? 0.5F*s : fl == EnumFacing.WEST ? s : s;
            float maxZ = fl == EnumFacing.NORTH ? 15.5F*s : fl == EnumFacing.SOUTH ? 15.5F*s : fl == EnumFacing.WEST ? 15*s : 15*s;
            list.add(new AxisAlignedBB(minX, 4*s, minZ, maxX, 12*s, maxZ).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            list.add(new AxisAlignedBB(0, 0, 0, 1, 4*s, 1).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            return list;
        } else if (this.pos == 10) {
            List list = Lists.newArrayList();
            ...
            list.add(new AxisAlignedBB(0, 0, 0, 1, 8*s, 1).offset(getPos().getX(), getPos().getY(), getPos().getZ()));
            return list;
        } else {
    ...
    public <T> T getCapability(Capability<T> capability, EnumFacing facing)
    {
        ...
        {
            TileEntityGristMill master = master();
            if (master==null)
                return null;
            if(pos==2)
    ...
    protected IMultiblockRecipe readRecipeFromNBT(NBTTagCompound tag)
    {
        ...
        return GristMillRecipe.loadFromNBT(tag);
    }
    @Override
    protected MultiblockProcess loadProcessFromNBT(NBTTagCompound tag)
    {
        IMultiblockRecipe recipe = readRecipeFromNBT(tag);
        if(recipe!=null && recipe instanceof GristMillRecipe)
            return new TileEntityGristMill.MultiblockProcessGristMill((GristMillRecipe) recipe, tag.getIntArray("process_inputSlots"));
        return null;
    }
    ...
    public int getGuiID()
    {
        return Reference.GUIID_GristMill;
    }
    ...
    {
        TileEntityGristMill master = this.master();
    ...
    @Override
    public TileEntityGristMill master()
    {
        ...
        return this.getClass().isInstance(te) ? (TileEntityGristMill) te : null;
    }

    @Override
    public TileEntityGristMill getTileForPos(int targetPos)
    {
        BlockPos target = getBlockPosForPos(targetPos);
        TileEntity tile = world.getTileEntity(target);
        return tile instanceof TileEntityGristMill ? (TileEntityGristMill) tile : null;
    }
    public static class MultiblockProcessGristMill extends MultiblockProcessInMachine<GristMillRecipe>
    {
        public MultiblockProcessGristMill(GristMillRecipe recipe, int... inputSlots)
        {
