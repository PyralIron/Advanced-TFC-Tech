...
public class BlockATTBase<E extends Enum<E> & BlockATTBase.IBlockEnum> extends Block implements IIEMetaBlock
{
    ...
    public BlockATTBase(String name, Material material, PropertyEnum<E> mainProperty, Class<? extends ItemBlockATTBase> itemBlock, Object... additionalProperties)
    {
        ...
        try
        {
            AdvancedTFCTech.registeredATTItems.add(itemBlock.getConstructor(Block.class).newInstance(this));
        } catch (Exception e)
        {
            e.printStackTrace();
        }
    ...
    public BlockATTBase setMetaHidden(int... meta)
    {
        for (int i : meta)
        {
    ...
    public BlockATTBase setMetaUnhidden(int... meta)
    {
        for (int i : meta)
        {
            if (i >= 0 && i < this.isMetaHidden.length)
    ...
    public BlockATTBase setHasFlavour(int... meta)
    {
    ...
    public BlockATTBase<E> setBlockLayer(BlockRenderLayer... layer)
    {
        this.renderLayers = Sets.newHashSet(layer);
        return this;
    }

    public BlockATTBase<E> setMetaBlockLayer(int meta, BlockRenderLayer... layer)
    {
    ...
    public BlockATTBase<E> setMetaLightOpacity(int meta, int opacity)
    {
    ...
    public BlockATTBase<E> setMetaExplosionResistance(int meta, int resistance)
    {
    ...
    public BlockATTBase<E> setNotNormalBlock(int meta)
    {
    ...
    public BlockATTBase<E> setAllNotNormalBlock()
    {
        if (metaNotNormalBlock == null)
            metaNotNormalBlock = new boolean[this.enumValues.length];
    ...
    public BlockATTBase<E> setOpaque(boolean isOpaque)
    {
        opaqueCube = isOpaque;
        fullBlock = isOpaque;
        return this;
